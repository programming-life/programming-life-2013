...
\hline 
\end{tabular} }
\date{April 5$^{th}$ 2013}
\begin{document}
\maketitle

\section*{Introduction}
The purpose of this report is to survey the context seminars and to briefly discuss our vision on the project and product itself.
The main focus of these seminars was to expand the domain knowledge necessary to make sure the target system will fully function in it's environment.
\\
\\
The report includes:
\begin{itemize}
