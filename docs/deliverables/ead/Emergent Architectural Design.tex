			...
			\subsection{Client}
				...
				\subsubsection{Models}
					\begin{figure}[htb]
						...
						\end{center}
					\end{figure}	
					There are two data models and a few meta models. The cell has it's own model and so do the modules, cell components, such as transporters and metabolites. Each JavaScript class maps to one ModuleTemplate and associated ModuleParameter classes on the server. Each of these data models can load and save itself. \\ 
